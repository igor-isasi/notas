        ...
        miBoton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!miTitulo.getText().toString().isEmpty()) {
                    ...
                    intent.putExtra("nota", miTitulo.getText().toString());
                    setResult(RESULT_OK, intent);
                    finish();
                }
                else {
                    Toast aviso = Toast.makeText(getApplicationContext(), getResources().getString(R.string.empty_title_note), Toast.LENGTH_SHORT);
                    aviso.show();
                }
            }
        });
